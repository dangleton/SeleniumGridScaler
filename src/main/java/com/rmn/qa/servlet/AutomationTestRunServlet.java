...
public class AutomationTestRunServlet extends RegistryBasedServlet implements RegistryRetriever {
     ...
     * @return
     */
    public static void startNodes(VmManager ec2, String uuid, int threadCountRequested, String browser,
            Platform platform) throws NodesCouldNotBeStartedException {
            ...
            for (Instance instance : instances) {
                ...
                AutomationContext.getContext().addNode(
                        new AutomationDynamicNode(uuid, instance.getInstanceId(), browser, platform,
                                instance.getPrivateIpAddress(), startDate, numThreadsPerMachine));
            }
        } catch (Exception e) {
